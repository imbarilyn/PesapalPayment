...
<template>
  <TransitionRoot :show="props.isOpen" appear as="template" @close="closeModal">
    <Dialog as="div" class="relative z-40 ">
      ...
      <div class="fixed inset-0 overflow-y-auto">
        <div class="flex min-h-full items-center justify-center p-4 text-center">
          ...
          >
            <DialogPanel
              :class="[subscriptionStore.getIframe?.iframeContent? 'w-max-w md:w-8/12': props.maxWidth]"
            ...
            >
              ...
              <div class="mt-2">
                <slot name="body">
                  ...
                  voluptatem accusamus distinctio, ab quia dicta, ut fugiat doloribus reprehenderit,
                  quod voluptates.
                </slot>
              </div>
